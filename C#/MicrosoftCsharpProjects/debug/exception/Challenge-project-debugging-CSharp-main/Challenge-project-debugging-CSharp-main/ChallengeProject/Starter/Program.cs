...
while (transactions > 0)
{
    ...
    int paymentOnes = itemCost % 5;                 // value is 1 when itemCost is odd, value is 0 when itemCost is even
    int paymentFives = (itemCost % 10 > 4) ? 1 : 0; // value is 1 when itemCost ends with 8 or 9, otherwise value is 0
    int paymentTens = (itemCost % 20 > 9) ? 1 : 0; // value is 1 when 13 < itemCost < 20 OR 33 < itemCost < 40, otherwise value is 0
    int paymentTwenties = (itemCost < 20) ? 0 : ((itemCost>20&&itemCost<40)?1:2);  // value is 1 when itemCost < 20, otherwise value is 2
