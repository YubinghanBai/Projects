        ...
        case "2":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    for (int j = 0; j < dogSearches.Length; j++)
                    {
                        if (dogSearches[j] != null && dogSearches[j].Trim() != "")
                        {
                            for (int jj = 2; jj > -1; jj--)
                            {
                                foreach (string icon in searchingIcons)
                                {
                                    Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {dogSearches[j].Trim()} {icon} {jj.ToString()}");
                                    Thread.Sleep(100);
                            ...
                            if (ourAnimals[i, 4].Contains(dogSearches[j]) || ourAnimals[i, 5].Contains(dogSearches[j]))
                            {
                                matchesCurrentDog = true;
                                matchesAnyDog = true;
                                Console.WriteLine($"Our dog {ourAnimals[i, 3]} matches your search for {dogSearches[j]}");
                            }
                        }
