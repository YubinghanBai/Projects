...
#Bonus Questions
#You Again
#The again function returns the smallest nonnegative integer n for which f(n) is equal to f(m) for some non-negative m that is less than n. Assume that f
